...
class SizingSettingsModel:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            self, "window_size", self.settings.value("window_size", type=QSize)
        )
        object.__setattr__(
            self, "window_position", self.settings.value("window_position", type=QPoint)
        )
        object.__setattr__(
            self, "window_state", self.settings.value("window_state", type=int)
        )
